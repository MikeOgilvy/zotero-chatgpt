...
import type { AgentTaskRecord, AnnotationTaskItem } from '../../packages/contracts/src/tasks.ts';
import type { NativeItemSnapshot } from '../../packages/contracts/src/agent.ts';
...
const task = (): AgentTaskRecord => ({ ...base, kind: 'annotations', paper: paperA, documentRevision: revision, items: [annotation('one'), annotation('two'), annotation('three', false)] });
...
function acquisition(): AgentTaskRecord {
