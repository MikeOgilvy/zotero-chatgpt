...
import type { NativeAnnotationCandidate, NativeMetadata } from '../../../packages/contracts/src/native.ts';
...
import type { HostEnvironment, NativeHostItem, NativeZoteroHost } from '../../../packages/zotero/src/host/native.ts';
