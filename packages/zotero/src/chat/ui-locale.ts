...
const COPY: Readonly<Record<string, string>> = {
  ...
  'Saved chats, articles and skills': '已保存的对话、文章与 skill',
  ...
  'Add references or skills': '添加引用或 skill', 'Close preview': '关闭预览', 'Reference preview': '引用预览',
  ...
  'Save': '保存',
  'Installed skills': '已安装的 skill', 'Create skill': '创建 skill', 'Import skill': '导入 skill',
  Name: '名称', Description: '说明', Version: '版本', 'SKILL.md content': 'SKILL.md 内容',
  'Read and explain': '阅读与解释', 'Review annotations': '审核标注', 'Acquire literature': '获取文献', 'Create diagram': '生成示意图',
  Enabled: '已启用', 'Save skill': '保存 skill', 'Cancel editing': '取消编辑', Duplicate: '创建副本', Export: '导出',
