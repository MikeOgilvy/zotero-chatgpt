...
export interface RequestRecord { requestId: UUID; hash: string; hashVersion?: 2; state: RequestState; turnId: string | null; createdAt: string; updatedAt: string; action?: 'explain' | 'ask' }
