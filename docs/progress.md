...
- 本机（macOS，代码树 `edb21a1`，`dist/` 现为 0.4.0a12 XPI，2026-09-18）：**1092 passed / 79 files / 0 skipped**；同一树在 `npm run package:dev` **之前**为 **1090 passed / 2 skipped**，差额即 `tests/build/install-lifecycle.test.ts` 的两条 `it.skipIf`（见下条）。
