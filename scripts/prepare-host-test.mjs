...
// demand; no synthetic fixture, preference or recorded artifact lives there.
if (tree.stage === 'context') await rm(join(profile, 'zotero-chatgpt'), { recursive: true, force: true });
